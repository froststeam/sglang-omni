...
> **Moore Threads GPU (MUSA)?** This page targets **NVIDIA CUDA**. For MUSA, see [Installation — MUSA](./installation_musa.md), which uses [`pyproject_musa.toml`](../../pyproject_musa.toml) on top of a SGLang MUSA environment.
>
